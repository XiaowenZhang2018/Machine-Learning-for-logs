...
inputLogs = ['RS'; 'SP'];
outputLog = 'VCL';
[X, Y, depth] = obtainData('zonesFile.txt', '172', 'BNS', inputLogs, outputLog);
...
%% Sort and Write
[depth,idx_depth] = sort(depth);
Y = [y_train; y_test];  Y = Y(idx_depth,:);
Y = [ones(3326,1)*-999.0000;Y;ones(2241,1)*-999.0000];
