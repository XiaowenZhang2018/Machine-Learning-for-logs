...
% backprop
for t = 1:m
    delta_5 = htheta(t)-y(t);
    delta_4 = Theta4'*delta_5;
    delta_3 = Theta3'*delta_4(2:end).*sigmoidGradient([1,z3(t,:)])';
    ...
    Theta3_grad = Theta3_grad+delta_4(2:end)*a3(t,:);
    Theta4_grad = Theta4_grad+delta_5*a4(t,:);
end
% regularization
